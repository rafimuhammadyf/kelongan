...
<html>
  <head>
  <title>Seller Kelongan.id</title>
</head>
...
<br>
    <div class="container">
      <br>
    <h1 style="float: left;">Seller</h1><br>
          @if (session('alert_pesan'))
          <div class="alert alert-success">
              {{ session('alert_pesan') }}
          </div>
          @endif
          <a href="{{url('seller_create')}}" style="float: right;" class="btn btn-sm btn-success">Tambah data seller</a><br><br>
